...
namespace WindowsFormsApp2.Forms.FormSetting.childSetting
{
    public partial class DoiMatKhau : Form
    {
        ...
        public DoiMatKhau(int currentUserId)
        {
            InitializeComponent();
        ...
        private void Quenmatkhau_Load(object sender, EventArgs e)
        {
            ...
            // setup textbox like bạn làm...
            var textbox1 = new[] { textbox_tk, textbox_otp, textbox_mkm, textbox_xnmk };
            foreach (var tb in textbox1)
            {
                tb.BorderRadius = 0;
                tb.BorderThickness = 0;
                tb.Style = Guna.UI2.WinForms.Enums.TextBoxStyle.Material;
            ...
            var user = UsersBUS.GetUserById(_currentUserId);

            if (user != null)
            {
                textbox_tk.Text = user.UserName;
                textbox_tk.ReadOnly = true;     // khóa lại không cho sửa
        ...
        private void button_dmk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (AuthBUS.ChangePassword(_currentUserName, textbox_mkm.Text.Trim()))
                {
